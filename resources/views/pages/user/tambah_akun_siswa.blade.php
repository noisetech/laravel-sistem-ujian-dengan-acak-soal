        ...
        <div class="card shadow">
            <div class="card-header">
                <div class="d-flex justify-content-between">
                    <span>
                        <i class="fas fa-sm fa-edit"></i> Form Tambah Akun Siswa
                    </span>
                </div>
            </div>
            <div class="card-body">
                <form action="{{ route('user.simpan_akun_siswa') }}" id="form_simpan" method="POST"
                    enctype="multipart/form-data">
                    @csrf

                    <div class="form-group">
                        <label for="">Siswa:</label>
                        <select name="siswa_id" class="form-control siswa"></select>
                    </div>
